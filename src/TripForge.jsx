...
1. Use real names — no generic placeholders.
1. Budget accurately for ${formData.travelers} traveler(s).
1. Keep descriptions SHORT — max 15 words each. Keep notes null unless essential.
1. Return ONLY valid JSON. No markdown. No commentary. No trailing commas.
...
return (
<>
<style>{`@import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,400&display=swap'); *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;} html{scroll-behavior:smooth;-webkit-text-size-adjust:100%;} body{background:${c.bg};font-family:${fontBody};-webkit-font-smoothing:antialiased;moz-osx-font-smoothing:grayscale;} @keyframes shimmer{0%{background-position:200% 0}100%{background-position:-200% 0}} @keyframes fadeUp{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:none}} @keyframes spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}} @keyframes progress{from{width:0%}to{width:95%}} @keyframes pulse{0%,100%{opacity:1}50%{opacity:0.5}} .pill-scroll::-webkit-scrollbar{display:none;} .pill-scroll{-ms-overflow-style:none;scrollbar-width:none;} input[type=date]::-webkit-calendar-picker-indicator{filter:${dark?"invert(0.6)":"none"};opacity:0.6;cursor:pointer;} ::-webkit-scrollbar{width:4px;height:4px;} ::-webkit-scrollbar-thumb{background:${c.accentBorder};border-radius:4px;} select option{background:${c.bg2};color:${c.text};} button,a{-webkit-tap-highlight-color:transparent;} @media print{ .no-print,header,footer{display:none!important;} body{background:white!important;} } .header-cta{display:none!important;} @media(min-width:640px){.header-cta{display:inline-flex!important;}} /* Smooth section fade-in on scroll */ @keyframes sectionIn{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:none}}`}</style>
